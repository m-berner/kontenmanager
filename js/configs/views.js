...
export const createPrivacyContent = (t) => [
    {
...
export const createHomeMenuItems = (t) => [
    {
        id: "update-booking",
...
export const createCompanyHeaders = (t) => [
...
export const createCompanyMenuItems = (t) => [
    {
        id: "update-stock",
