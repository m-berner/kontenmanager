...
describe("Stocks Store", () => {
    ...
    describe("Getters", () => {
        ...
        it("active should sort by cFirstPage and then by mPortfolio value", () => {
            ...
            bookingsStore.items = [
                createSampleBooking({ cStockID: 1, cCount: 10 }),
                createSampleBooking({ cStockID: 3, cCount: 20 })
            ];
    ...
    describe("Actions", () => {
        ...
        it("update should modify an existing stock and keep RAM data", () => {
            ...
            stocksStore.items[0].mValue = 500;
    ...
    describe("sumDepot", () => {
        ...
        it("should calculate the total depot value correctly including fractional shares", () => {
            ...
            bookingsStore.items = [
                createSampleBooking({ cStockID: 1, cCount: 10.5 }),
                createSampleBooking({ cStockID: 2, cCount: 0.05 })
            ];
