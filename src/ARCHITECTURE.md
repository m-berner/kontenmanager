...
KontenManager is a Firefox web extension (Manifest V3) for managing investment portfolios. Users track accounts, stocks,
and bookings (transactions), and the extension fetches live market data from several financial data providers.
