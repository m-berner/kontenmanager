...
const taxModel = computed(
    {
        get: () => ({credit: bookingFormData.taxCredit, debit: bookingFormData.taxDebit}),
        set: (val) => {
...
const feeModel = computed(
    {
        get: () => ({credit: bookingFormData.feeCredit, debit: bookingFormData.feeDebit}),
        set: (val) => {
...
const isStockBookingType = computed(() => bookingFormData.selected === INDEXED_DB.STORE.BOOKING_TYPES.BUY || bookingFormData.selected === INDEXED_DB.STORE.BOOKING_TYPES.SELL || bookingFormData.selected === INDEXED_DB.STORE.BOOKING_TYPES.DIVIDEND)
const isDividendType = computed(() => bookingFormData.selected === INDEXED_DB.STORE.BOOKING_TYPES.DIVIDEND)
const isBuySellType = computed(() => bookingFormData.selected === INDEXED_DB.STORE.BOOKING_TYPES.BUY || bookingFormData.selected === INDEXED_DB.STORE.BOOKING_TYPES.SELL)
const isBuyType = computed(() => bookingFormData.selected === INDEXED_DB.STORE.BOOKING_TYPES.BUY)
const isDividendSellType = computed(() => bookingFormData.selected === INDEXED_DB.STORE.BOOKING_TYPES.SELL || bookingFormData.selected === INDEXED_DB.STORE.BOOKING_TYPES.DIVIDEND)
...
UtilsService.log('--- components/dialogs/forms/BookingForm.vue setup ---')
</script>
    ...
    <v-container>
        ...
        <v-row justify="center">
            <CreditDebitFieldset
                ...
                :rules="[(v: number) => ValidationService.amountRules(v, RULES), (v: number) => ValidationService.amountRules(v, RULES)]"/>
        </v-row>
