...
const defaultAlert: VisibleAlertData = {id: -1, type: undefined, title: '', message: ''}
const defaultConfirmation: ConfirmationDialogData = {
    id: -1,
    title: '',
    message: '',
    confirmText: 'Confirm',
...
export const useAlertStore = defineStore('alert', () => {
    ...
    const confirmationDialog = ref<ConfirmationDialogData>(defaultConfirmation)
     ...
     * @returns Alert ID.
     */
    function success(title: string, message: string, duration: number | null = null): number {
     ...
     * @returns Alert ID.
     */
    function error(title: string, message: string, duration: number | null = null): number {
     ...
     * @returns Alert ID.
     */
    function warning(title: string, message: string, duration: number | null = null): number {
     ...
     * @returns Alert ID.
     */
    function info(title: string, message: string, duration: number | null = null): number {
