...
describe('Stocks Store', () => {
    ...
    describe('sumDepot', () => {
        it('should calculate the total depot value correctly', () => {
            ...
            // Mock active stocks (active filters by cID > 0 and cFadeOut === 0)
            stocksStore.items = [
                {
                    cID: 1,
                    cCompany: 'Apple',
                ...
                },
                {
                    ...
                    cAccountNumberID: 1,
                    cAskDates: '',
                    mValue: 250 // Stock price
                }
            ]

            // Mock portfolio (portfolioByStockId is used by actively computed)
            bookingsStore.items = [
                {
                    cID: 1,
                    cStockID: 1,
            ...
            // Expected sumDepot: (10 * 200) + (5 * 250) = 2000 + 1250 = 3250
        ...
        it('should update original items when loadOnlineData is called', async () => {
            ...
            // active mapping returns objects with id (mapped from cID)
        ...
        it('should trigger reactivity when fading in a stock', () => {
            ...
            stocksStore.items = [{
                ...
                cISIN: 'US1234567890',
                cSymbol: 'TEST',
                cFadeOut: 1, // Initially faded out
                cFirstPage: 0,
                cURL: '',
                cMeetingDay: '',
                cQuarterDay: '',
            ...
            // Initially it should be passive
            expect(stocksStore.passive).toHaveLength(1)
            expect(stocksStore.active).toHaveLength(0)
            ...
            // After the update with cFadeOut: 0, it should be moved to active
            expect(stocksStore.active).toHaveLength(1)
        ...
        it('should trigger reactivity when removing a stock', () => {
            ...
            // After removal, it should be removed from active
            expect(stocksStore.active).toHaveLength(0)
        })
