...
- **`useAlert.ts`**: Centralized user-facing feedback layer (info/warning/error/confirm) built on top of the alert store.
  It provides consistent message normalization, defaults, logging, and rate limiting.
