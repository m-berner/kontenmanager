export const useApp = () => {
    ...
    (function (MESSAGES) {
        ...
        MESSAGES[MESSAGES["OPTIONS__SET_SKIN"] = 27] = "OPTIONS__SET_SKIN";
        MESSAGES[MESSAGES["OPTIONS__SET_SERVICE"] = 28] = "OPTIONS__SET_SERVICE";
        MESSAGES[MESSAGES["OPTIONS__SET_INDEXES"] = 29] = "OPTIONS__SET_INDEXES";
        MESSAGES[MESSAGES["OPTIONS__SET_MATERIALS"] = 30] = "OPTIONS__SET_MATERIALS";
        MESSAGES[MESSAGES["OPTIONS__SET_EXCHANGES"] = 31] = "OPTIONS__SET_EXCHANGES";
        MESSAGES[MESSAGES["OPTIONS__SET_MARKETS"] = 32] = "OPTIONS__SET_MARKETS";
        MESSAGES[MESSAGES["DB__EXPORT"] = 33] = "DB__EXPORT";
        MESSAGES[MESSAGES["OPTIONS__SET_SKIN__RESPONSE"] = 34] = "OPTIONS__SET_SKIN__RESPONSE";
        MESSAGES[MESSAGES["OPTIONS__SET_SERVICE__RESPONSE"] = 35] = "OPTIONS__SET_SERVICE__RESPONSE";
        MESSAGES[MESSAGES["OPTIONS__SET_INDEXES__RESPONSE"] = 36] = "OPTIONS__SET_INDEXES__RESPONSE";
        MESSAGES[MESSAGES["OPTIONS__SET_MATERIALS__RESPONSE"] = 37] = "OPTIONS__SET_MATERIALS__RESPONSE";
        MESSAGES[MESSAGES["OPTIONS__SET_MARKETS__RESPONSE"] = 38] = "OPTIONS__SET_MARKETS__RESPONSE";
        MESSAGES[MESSAGES["OPTIONS__SET_EXCHANGES__RESPONSE"] = 39] = "OPTIONS__SET_EXCHANGES__RESPONSE";
        MESSAGES[MESSAGES["FETCH__COMPANY_DATA"] = 40] = "FETCH__COMPANY_DATA";
        MESSAGES[MESSAGES["FETCH__EXCHANGES_BASE_DATA"] = 41] = "FETCH__EXCHANGES_BASE_DATA";
        MESSAGES[MESSAGES["FETCH__INDEXES_DATA"] = 42] = "FETCH__INDEXES_DATA";
        MESSAGES[MESSAGES["FETCH__MATERIALS_DATA"] = 43] = "FETCH__MATERIALS_DATA";
        MESSAGES[MESSAGES["FETCH__EXCHANGES_DATA"] = 44] = "FETCH__EXCHANGES_DATA";
        MESSAGES[MESSAGES["FETCH__DAILY_CHANGES_DATA"] = 45] = "FETCH__DAILY_CHANGES_DATA";
        MESSAGES[MESSAGES["FETCH__DATES_DATA"] = 46] = "FETCH__DATES_DATA";
        MESSAGES[MESSAGES["FETCH__MIN_RATE_MAX_DATA"] = 47] = "FETCH__MIN_RATE_MAX_DATA";
    })(MESSAGES || (MESSAGES = {}));
