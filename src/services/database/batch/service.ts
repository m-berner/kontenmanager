 ...
 */
export function createBatchOperationService(transactionManager: any) {
    /**
    ...
    function createBuilder(): any {
        return createBatchOperationBuilder({executeAtomic, executeBatch, createBuilder});
    }
 ...
 * Creates a fluent builder for batch operations
 */
export function createBatchOperationBuilder(service: any) {
