...
import {validateBookingType} from "@/domains/validation/validators";
 ...
 */
export function createBookingTypeRepository(transactionManager: any) {
    ...
    async function save(data: BookingTypeDb | Omit<BookingTypeDb, "cID">, options = {}): Promise<number> {
        return base.save(validateBookingType(data as any), options);
    }
