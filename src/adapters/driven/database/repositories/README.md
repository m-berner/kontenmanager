...
This directory contains the concrete implementation of the data access layer. Repositories are responsible for
interacting with the IndexedDB database to perform CRUD operations on domain entities.

Each repository is created via `createBaseRepository()`, spreading its returned CRUD operations into the entity-specific
repository object (functional composition, not class inheritance).
