...
const routes: RouteMeta[] = [
    {
        ...
        name: "home",
        components: {
            default: () => import("@/adapters/ui/views/HomeContent.vue"),
            title: () => import("@/adapters/ui/views/TitleBar.vue"),
            header: () => import("@/adapters/ui/views/HeaderBar.vue"),
            footer: () => import("@/adapters/ui/views/FooterBar.vue")
        }
    },
    {
        path: "/company",
        name: "company",
        components: {
            default: () => import("@/adapters/ui/views/CompanyContent.vue"),
            title: () => import("@/adapters/ui/views/TitleBar.vue"),
            header: () => import("@/adapters/ui/views/HeaderBar.vue"),
            info: () => import("@/adapters/ui/views/InfoBar.vue"),
            footer: () => import("@/adapters/ui/views/FooterBar.vue")
        }
    },
    {
        ...
        name: "privacy",
        components: {
            default: () => import("@/adapters/ui/views/PrivacyContent.vue"),
            title: () => import("@/adapters/ui/views/TitleBar.vue"),
            header: () => import("@/adapters/ui/views/HeaderBar.vue"),
            footer: () => import("@/adapters/ui/views/FooterBar.vue")
        }
    },
    {
        ...
        name: "help",
        components: {
            default: () => import("@/adapters/ui/views/HelpContent.vue"),
            title: () => import("@/adapters/ui/views/TitleBar.vue"),
            header: () => import("@/adapters/ui/views/HeaderBar.vue"),
            footer: () => import("@/adapters/ui/views/FooterBar.vue")
        }
