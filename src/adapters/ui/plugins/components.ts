...
import AddAccount from "@/adapters/ui/components/dialogs/AddAccount.vue";
import AddBooking from "@/adapters/ui/components/dialogs/AddBooking.vue";
import AddBookingType from "@/adapters/ui/components/dialogs/AddBookingType.vue";
import AddStock from "@/adapters/ui/components/dialogs/AddStock.vue";
import DeleteAccountConfirmation from "@/adapters/ui/components/dialogs/DeleteAccountConfirmation.vue";
import DeleteBookingType from "@/adapters/ui/components/dialogs/DeleteBookingType.vue";
import ExportDatabase from "@/adapters/ui/components/dialogs/ExportDatabase.vue";
import FadeInStock from "@/adapters/ui/components/dialogs/FadeInStock.vue";
import ImportDatabase from "@/adapters/ui/components/dialogs/ImportDatabase.vue";
import ShowAccounting from "@/adapters/ui/components/dialogs/ShowAccounting.vue";
import ShowDividend from "@/adapters/ui/components/dialogs/ShowDividend.vue";
import UpdateAccount from "@/adapters/ui/components/dialogs/UpdateAccount.vue";
import UpdateBooking from "@/adapters/ui/components/dialogs/UpdateBooking.vue";
import UpdateBookingType from "@/adapters/ui/components/dialogs/UpdateBookingType.vue";
import UpdateStock from "@/adapters/ui/components/dialogs/UpdateStock.vue";
