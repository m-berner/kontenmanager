...
This directory contains the user interface components and related logic for the extension. It follows the primary
adapter pattern, providing the bridge between the user and the application's core logic.
