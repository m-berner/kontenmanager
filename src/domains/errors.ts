...
/**
 * Checks if a value is an AppError object.
 */
...
/**
 * Interface for application-specific errors.
 */
export interface AppError extends Error {
    code: keyof typeof deNotifications | keyof typeof ERRORS;
...
/**
 * Custom error factory for application-specific errors.
