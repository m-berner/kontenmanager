...
- `STOCK_STORE_MEMORY`: Default in-memory fields for stock calculations. Merged into stock items during initialization to keep computed fields present and typed.
