...
export interface AppMetadata {
    /**
     * Application version, verbatim from the manifest (e.g. `"1.10.0"`).
     *
     * A string, matching `BackupMetadata.cVersion` — this is the same value,
     * seen from the writing side. See that declaration for why the previous
     * numeric encoding was lossy.
     */
    cVersion: string;
