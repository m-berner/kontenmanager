...
import type {DialogNameType, MenuActionType, ViewTypeSelectionType} from "@/types";
 ...
 *
 * @param {DialogNameType} dialogName - The name of the dialog to open.
 * @param {boolean} [dialogOk=true] - Indicates whether the dialog is confirmed or accepted by default.
 * @returns {void}
 */
