...
- Doc set: root `README.md`, one `README.md` per hexagonal-layer folder under `src/`
  (`domain/`, `app/usecases/`, `adapters/ui/*`, `adapters/driven/*`, …), `src/ARCHITECTURE.md`,
  `src/WORKFLOWS.md`, `tests/README.md`, `scripts/README.md`.
...
- Root `README.md` has historically drifted after refactors: it once described a pre-hexagonal
  ...
  `src/ARCHITECTURE.md` — the two can silently disagree.
