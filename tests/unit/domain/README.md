...
`logic.ts` modules directly; everything else mirrors a `src/domain/` subdirectory 1:1
(`importExport/`, `mapping/`, `utils/`, `validation/`). `constants/` and `types/` have no tests
